...
public class Constant {
    ...
    public static final String URL3 = "https://ressources.data.sncf.com/api/records/1.0/search/?dataset=objets-trouves-gares&q=%s&rows=100&sort=date&facet=gc_obo_gare_origine_r_name&refine.date=%s";
